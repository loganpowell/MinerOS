...
Starting with 3.0, `mineros` runs as an orchestration client on top of `mineros-api`; advanced `mineros-router` usage for multi-service and multi-GPU deployments is also covered in this section.
