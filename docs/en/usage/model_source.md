...
>- You can also create it by copying the [configuration template file](https://github.com/loganpowell/MinerOS/blob/main/mineru.template.json) to your user directory and renaming it to `mineros.json`.
