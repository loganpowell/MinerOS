...
```bash
wget https://raw.githubusercontent.com/loganpowell/MinerOS/main/docker/china/gcu.Dockerfile
docker build --network=host -t mineros:gcu-vllm-latest -f gcu.Dockerfile .
```
...
不同环境下，MinerOS对Enflame加速卡的支持情况如下表所示：
...
>[!TIP]
> - GCU加速卡指定可用加速卡的方式与NVIDIA GPU类似，请参考[使用指定GPU设备](https://loganpowell.github.io/MinerOS/zh/usage/advanced_cli_parameters/#cuda_visible_devices)章节说明,
