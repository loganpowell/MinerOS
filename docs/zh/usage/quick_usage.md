...
>[!IMPORTANT]
>`mineros.json` 文件会在您使用内置模型下载命令 `mineros-models-download` 时自动生成，也可以通过将[配置模板文件](https://github.com/loganpowell/MinerOS/blob/main/mineru.template.json)复制到用户目录下并重命名为 `mineros.json` 来创建。  
