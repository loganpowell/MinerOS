...
目前，Sider在 Wisebase 模块中深度集成了 MinerOS 的相关功能。该模块是一个由AI驱动的知识库，您可以通过上传 PDF 等各类型文件，构建个人图书馆以实现高效的知识管理，MinerOS 可以帮助您更好地解析此类文件，精准地提取文件中的信息。

![img](../../../assets/images/Sider_1.png)

- Sider 官网地址：https://sider.ai/zh-CN/chat
- 使用集成 MinerOS 相关功能的 Sider 地址：https://sider.ai/zh-CN/wisebase