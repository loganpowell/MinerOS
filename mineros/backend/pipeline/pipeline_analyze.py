...
from .model_init import MinerOSPipelineModel, PIPELINE_MODEL_INIT_LOCK
...
def custom_model_init(
    ...
    custom_model = MinerOSPipelineModel(**model_input)
            ...
            while processed_pages < total_pages:
                ...
                for context in doc_contexts:
                    ...
                    batch_payloads.append(
                        (context, images_list, page_start, take_count)
                    )
                ...
                for context, images_list, page_start, take_count in batch_payloads:
                    result_slice = batch_results[
                        result_offset : result_offset + take_count
                    ]
                    append_batch_results_to_middle_json(
                        context["middle_json"],
                        result_slice,
                    ...
                    if (
                        context["next_page_idx"] >= context["page_count"]
...
def batch_image_analyze(
    ...
    batch_model = BatchAnalyze(
        model_manager, batch_ratio, formula_enable, table_enable, enable_ocr_det_batch
    )
