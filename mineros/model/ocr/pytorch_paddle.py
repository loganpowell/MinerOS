...
from mineros.model.ocr.seal_crop import CropByPolys, SortPolyBoxes
from mineros.utils.config_reader import get_device
...
from mineros.utils.ocr_utils import (
    check_img,
    preprocess_image,
    sorted_boxes,
    merge_det_boxes,
...
from mineros.model.utils.tools.infer.predict_system import TextSystem
